...
function dropping() {
    if ((yBlock % 30 == 1 && yBlock > 0 || yBlock % 30 == -29) && (yBlock + Math.max(y2, y3, y4) * 30 > 570 || checkBlock(xBlock, Math.ceil(yBlock / 30), x1, x2, y2, x3, y3, x4, y4) == false)) {
        ...
        clearRow(yBlock / 30, yBlock / 30 + Math.max(y2, y3, y4));
        return 0;
    }
